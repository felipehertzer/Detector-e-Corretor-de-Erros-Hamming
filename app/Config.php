...
class Config
{
    ...
    public function __construct()
    {
         ...
         */
        define('SITEURL', 'http://hamming.16mb.com/');
         ...
         */
        define('DEFAULT_CONTROLLER', 'Gerador');
         ...
         */
        define('SESSION_PREFIX', 'comunicacao');

        /**
         * Optional create a constant for the name of the site.
         */
        define('SITETITLE', 'Trabalho 2 de Comunicação de Dados');
